...
import { cellSamplingDescription, receiverGridDescription } from '../domain/receiver-grid.js';
...
export function provenanceRecord(s, r, { control = false } = {}) {
  return {
    ...
    receivers: `${receiverGridDescription(s)}; ${s.analysis.receiverHeight} m height; horizontal. ${cellSamplingDescription(s.analysis.samplesPerCell)}`,
    openField: r
